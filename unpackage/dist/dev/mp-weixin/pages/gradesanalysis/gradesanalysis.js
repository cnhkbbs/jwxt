...
const _sfc_main = {
  ...
  methods: {
    ...
    getPassRate() {
      ...
      this.arcbar_opts["title"]["name"] = pass_rate_str + "%";
    },
    loadUserData() {
      return new Promise((resolve) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/vue/jwxt/pages/gradesanalysis/gradesanalysis.vue"]]);
